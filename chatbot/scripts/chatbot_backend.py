...
from chatbot_actions import Actions
...
class Chatbot():
    ...
    def __init__(self):
        ...
        model_path = r"C:\python\NLP\content_searcher\chatbot\models\20230808-230511-adaptive-data.tar.gz"
