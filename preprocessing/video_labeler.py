        ...
        for file in os.listdir(folder_path):
            if file.endswith("mp4"):
                ...
                for frame_index in range(0, frame_count, self.skip_frames + 1):
                    ...
                    labels , actions = self.process_request(caption)
                    print("the labels are : " + "_".join(labels))
                    print("the actions are : " + "__".join(actions))
                    containing_objects.append("_".join(labels.copy()))
                    containing_captions.append("___".join(actions.copy()))
                ...
                print(" in the video objects are : " + str(containing_objects))
                print(" in the video captions are : " + str(containing_captions))
                # appending the labels detected from the video
                labels , actions = self.process_request("__".join(unique_caption_list))
                info_dict["All_Objects"].append("_".join(labels))
                info_dict["All_Captions"].append("_#_".join(actions))
                info_dict["Containing_Objects"].append("@".join(containing_objects))
                info_dict["Containing_Captions"].append("@".join(containing_captions))

        print(len(info_dict["All_Captions"]))
        print(len(info_dict["All_Objects"]))
